...
interface BentoToggleButtonProps extends Omit<ButtonHTMLAttributes<HTMLButtonElement>, 'children'> {
  icon: ReactNode
  label: string
...
export default function BentoToggleButton({
  ...
  return (
    ...
    >
      <span
        className={cn('flex items-center justify-center text-[var(--text-color)]', iconClassName)}
      >
        {icon}
      </span>
