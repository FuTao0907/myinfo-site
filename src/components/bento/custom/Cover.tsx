...
const Cover: React.FC = () => {
  return (
    <div className="cover-container relative h-full w-full overflow-hidden rounded-[10px] bg-[var(--cover-main-color)]">
      <div className="inner-container pointer-events-none absolute left-1/2 top-1/2 !h-[90%] !w-[90%] border-[2px] border-[#457AF7] rounded-[6px] border-solid bg-[var(--cover-main-color)] px-4 py-8 translate-x-[-50%] translate-y-[-50%] dark:border-[#474d63]">
        ...
        <div className="text-[36px] text-[#c29048] font-bold leading-normal font-[fantasy]">
          My default cover
        </div>

        <div className="text-[24px] text-[#ffffff] font-bold leading-normal tracking-widest font-[fantasy]">
          {`< Ango  /> `}
        </div>
      </div>
