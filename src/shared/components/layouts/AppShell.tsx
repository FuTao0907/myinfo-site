...
import SiteHeader from '~/shared/components/layouts/SiteHeader'
import { SiteConfigProvider } from '~/shared/components/providers/SiteConfigProvider'
import { ToastProvider } from '~/shared/components/providers/ToastProvider'
import SearchDialog from '~/shared/components/search/SearchDialog'
import { COMMON_ASSETS, SITE_RECORDS } from '~/shared/lib/constants/content/site'
